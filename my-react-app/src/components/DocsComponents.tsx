...
import ComponentsImg from '@/assets/images/components.webp'; // Correct: using alias

// 1. Define the Props Interface
interface DocsComponentsProps {
  href?: string; // Optional prop, as it might not always be provided
}

// 2. Use the Interface to Type the Props
const DocsComponents: React.FC<DocsComponentsProps> = (props) => (
